...
`Class(name=Struct QueryOptions, anchor=Struct_QueryOptions, enumConstants=[], description=[, TypeDB query options. ``QueryOptions`` object can be used to override the default server behaviour for executed queries.
