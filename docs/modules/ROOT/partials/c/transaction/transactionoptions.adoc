...
`Class(name=Struct TransactionOptions, anchor=Struct_TransactionOptions, enumConstants=[], description=[, TypeDB transaction options. ``TransactionOptions`` object can be used to override the default server behaviour for opened transactions.
