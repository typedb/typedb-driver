...
==== function ``concept_get_date_as_seconds``
...
==== function ``concept_get_datetime_tz``
...
[#_concept_get_vector_element]
==== function ``concept_get_vector_element``

[source,c]
----
float concept_get_vector_element(const struct Concept* concept, int64_t index)
----



Returns the element at the given index of the ``vector`` value of this value concept. If the value has another type or the index is out of bounds, the error is set.

[caption=""]
.Returns
`float`

[#_concept_get_vector_length]
==== function ``concept_get_vector_length``

[source,c]
----
int64_t concept_get_vector_length(const struct Concept* concept)
----



Returns the number of elements in the ``vector`` value of this value concept. If the value has another type, the error is set.
...
==== function ``concept_is_attribute_type``
...
==== function ``concept_is_datetime_tz``
...
==== function ``concept_is_entity_type``
...
==== function ``concept_is_relation_type``
...
[#_concept_is_vector]
==== function ``concept_is_vector``

[source,c]
----
bool concept_is_vector(const struct Concept* concept)
----



Returns ``true`` if the value which this ``Concept`` holds is of type ``vector``. Otherwise, returns ``false``.

[caption=""]
.Returns
`bool`

[#_concept_new_boolean]
==== function ``concept_new_boolean``
...
[#_concept_new_date_from_seconds]
==== function ``concept_new_date_from_seconds``
...
[#_concept_new_datetime]
==== function ``concept_new_datetime``
...
[#_concept_new_datetime_tz_iana]
==== function ``concept_new_datetime_tz_iana``
...
[#_concept_new_datetime_tz_offset]
==== function ``concept_new_datetime_tz_offset``
...
[#_concept_new_decimal]
==== function ``concept_new_decimal``
...
[#_concept_new_decimal_from_string]
==== function ``concept_new_decimal_from_string``
...
[#_concept_new_duration]
==== function ``concept_new_duration``
...
[#_concept_new_integer]
==== function ``concept_new_integer``
...
[#_concept_new_vector_from_string]
==== function ``concept_new_vector_from_string``

[source,c]
----
struct Concept* concept_new_vector_from_string(const char* str)
----



Creates a new ``Concept`` object wrapping a ``vector`` value, provided as a comma-separated string of float elements (e.g. "1.0,2.5,3.0").
...
==== function ``concept_try_get_label``
...
==== function ``concept_try_get_value``
...
==== function ``concept_try_get_value_type``
