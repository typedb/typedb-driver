...
`Class(name=Struct Database, anchor=Struct_Database, enumConstants=[], description=[, A TypeDB database], examples=[], fields=[], methods=[], packagePath=null, superClasses=[], traitImplementors=[], mode=null).nameDescriptor(language)`
