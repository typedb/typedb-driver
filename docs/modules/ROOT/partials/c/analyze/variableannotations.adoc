...
==== function ``variable_annotations_drop``
...
==== function ``variable_annotations_instance``
...
==== function ``variable_annotations_type``
...
==== function ``variable_annotations_value``
...
==== function ``variable_annotations_variant``
