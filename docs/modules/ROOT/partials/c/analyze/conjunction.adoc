...
[#_conjunction_drop]
==== function <code>conjunction_drop</code>
...
==== function <code>conjunction_get_annotated_variables</code>
...
==== function <code>conjunction_get_constraints</code>
...
==== function <code>conjunction_get_variable_annotations</code>
