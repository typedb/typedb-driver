...
[#_bool_TypeDB_Driver_Api_IConcept_IsVector_]
==== method ``IsVector``
...
Returns true if the value which this Concept holds is of type vector or if this Concept is an AttributeType of type vector.
...
[#_IReadOnlyList_float_TypeDB_Driver_Api_IConcept_TryGetVector_]
==== method ``TryGetVector``
...
Returns a vector value of this Concept. If it's not a Value or it has another type, returns null.
