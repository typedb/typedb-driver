...
[#_IVectorSearch_TypeDB_Driver_Api_Analyze_IConstraint_AsVectorSearch_]
==== method ``AsVectorSearch``
...
[#_bool_TypeDB_Driver_Api_Analyze_IConstraint_IsVectorSearch]
==== method ``IsVectorSearch``

[source,cs]
----
bool TypeDB.Driver.Api.Analyze.IConstraint.IsVectorSearch
----
