...
[#_IDeleteConcepts_TypeDB_Driver_Api_Analyze_IConstraint_AsDeleteConcepts_]
==== method ``AsDeleteConcepts``
...
[#_bool_TypeDB_Driver_Api_Analyze_IConstraint_IsDeleteConcepts]
==== method ``IsDeleteConcepts``

[source,cs]
----
bool TypeDB.Driver.Api.Analyze.IConstraint.IsDeleteConcepts
----
