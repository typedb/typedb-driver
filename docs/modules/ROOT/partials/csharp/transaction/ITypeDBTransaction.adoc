...
// tag::methods[]
[#_Promise_IAnalyzedQuery_TypeDB_Driver_Api_ITypeDBTransaction_Analyze_string_query_]
==== method ``Analyze``
...
[#_Promise_IQueryAnswer_TypeDB_Driver_Api_ITypeDBTransaction_Query_string_query_]
==== method ``Query``
...
[#_Promise_IQueryAnswer_TypeDB_Driver_Api_ITypeDBTransaction_Query_string_query_QueryOptions_options_]
==== method ``Query``
