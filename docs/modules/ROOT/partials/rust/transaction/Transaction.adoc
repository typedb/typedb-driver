...
[#_struct_Transaction_query_with_options_and_rows_query_impl_AsRef_str_options_QueryOptions_rows_Option_GivenRows_]
==== query_with_options_and_rows
...
a| `query` a|  — The TypeQL query to be executed a| `impl AsRef<str>`
a| `options` a|  — The QueryOptions to execute the query with a| `QueryOptions`
a| `rows` a|  — The GivenRows to pass as input to the query. a| `Option<GivenRows>`
|===
...
[#_struct_Transaction_query_with_rows_query_impl_AsRef_str_rows_GivenRows]
==== query_with_rows
...
|Name |Description |Type
a| `query` a|  — The TypeQL query to be executed a| `impl AsRef<str>`
a| `rows` a|  — The GivenRows to pass as input to the query. a| `GivenRows`
|===
