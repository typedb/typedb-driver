...
See <<#_struct_TypeDBDriver_method_primary_replica_with_routing,`Self::primary_replica_with_routing`>> for more details and options.
...
[#_struct_TypeDBDriver_primary_replica_with_routing_server_routing_ServerRouting]
==== primary_replica_with_routing
...
[source,rust]
----
pub fn primary_replica_with_routing(
    &self,
    server_routing: ServerRouting,
) -> Result<Option<AvailableServerReplica>>
----
...
[source,rust]
----
driver.primary_replica_with_routing(ServerRouting::Auto).await;
----
...
[source,rust]
----
driver.primary_replica_with_routing(ServerRouting::Auto);
----
...
[source,rust]
----
pub fn servers(&self) -> Result<HashSet<ServerReplica>>
----
