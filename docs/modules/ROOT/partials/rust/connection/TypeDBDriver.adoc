...
[#_struct_TypeDBDriver_deregister_server_server_id_u64]
==== deregister_server
...
[source,rust]
----
pub async fn deregister_server(&self, server_id: u64) -> Result
----
...
[source,rust]
----
pub fn deregister_server(&self, server_id: u64) -> Result
----
...
a| `server_id` a|  — The numeric identifier of the deregistered server a| `u64`
|===
...
Retrieves the server’s primary server, if exists, using default strong consistency.

See <<#_struct_TypeDBDriver_method_primary_server_with_consistency,`Self::primary_server_with_consistency`>> for more details and options.
...
[#_struct_TypeDBDriver_primary_server_with_consistency_consistency_level_ConsistencyLevel]
==== primary_server_with_consistency
...
[source,rust]
----
pub async fn primary_server_with_consistency(
    &self,
...
[source,rust]
----
pub fn primary_server_with_consistency(
    &self,
    consistency_level: ConsistencyLevel,
) -> Result<Option<AvailableServer>>
----
...
[source,rust]
----
driver.primary_server_with_consistency(ConsistencyLevel::Strong).await;
----
...
[source,rust]
----
driver.primary_server_with_consistency(ConsistencyLevel::Strong);
----

--
====

[#_struct_TypeDBDriver_register_server_server_id_u64_address_String]
==== register_server
...
[source,rust]
----
pub async fn register_server(&self, server_id: u64, address: String) -> Result
----
...
[source,rust]
----
pub fn register_server(&self, server_id: u64, address: String) -> Result
----
...
|===
|Name |Description |Type
a| `server_id` a|  — The numeric identifier of the new server a| `u64`
...
[source,rust]
----
pub async fn replicas(&self) -> Result<HashSet<Server>>
----
...
[source,rust]
----
pub fn replicas(&self) -> Result<HashSet<Server>>
----
