...
[#_struct_TypeDBDriver_is_cluster_]
==== is_cluster
...
[#_struct_TypeDBDriver_new_cluster_init_addresses_Vec_T_credentials_Credentials_driver_options_DriverOptions]
==== new_cluster
...
[source,rust]
----
pub fn new_cluster<T: AsRef<str> + Sync>(
    init_addresses: &Vec<T>,
    credentials: Credentials,
    driver_options: DriverOptions,
) -> Result<Self>
...
[#_struct_TypeDBDriver_new_cluster_with_description_init_addresses_Vec_T_credentials_Credentials_driver_options_DriverOptions_driver_lang_impl_AsRef_str_]
==== new_cluster_with_description
...
[source,rust]
----
pub fn new_cluster_with_description<T: AsRef<str> + Sync>(
    init_addresses: &Vec<T>,
    credentials: Credentials,
    driver_options: DriverOptions,
    driver_lang: impl AsRef<str>,
...
[#_struct_TypeDBDriver_new_cluster_with_translation_address_translation_HashMap_T_credential_Credentials_driver_options_DriverOptions]
==== new_cluster_with_translation
...
[source,rust]
----
pub fn new_cluster_with_translation<T, U>(
    address_translation: HashMap<T, U>,
    credential: Credentials,
    driver_options: DriverOptions,
) -> Result<Self>where
...
[#_struct_TypeDBDriver_new_cluster_with_translation_with_description_address_translation_HashMap_T_credentials_Credentials_driver_options_DriverOptions_driver_lang_impl_AsRef_str_]
==== new_cluster_with_translation_with_description
...
[source,rust]
----
pub fn new_cluster_with_translation_with_description<T, U>(
    address_translation: HashMap<T, U>,
    credentials: Credentials,
    driver_options: DriverOptions,
    driver_lang: impl AsRef<str>,
