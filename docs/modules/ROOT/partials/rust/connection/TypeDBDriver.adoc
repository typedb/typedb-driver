...
[#_struct_TypeDBDriver_new_cloud_init_addresses_Vec_T_credentials_Credential_connection_settings_ConnectionSettings]
==== new_cloud
...
[#_struct_TypeDBDriver_new_cloud_with_description_init_addresses_Vec_T_credentials_Credential_connection_settings_ConnectionSettings_driver_lang_impl_AsRef_str_]
...
[#_struct_TypeDBDriver_new_cloud_with_translation_address_translation_HashMap_T_credentials_Credential_connection_settings_ConnectionSettings]
...
[#_struct_TypeDBDriver_new_cloud_with_translation_with_description_address_translation_HashMap_T_credentials_Credential_connection_settings_ConnectionSettings_driver_lang_impl_AsRef_str_]
...
[#_struct_TypeDBDriver_new_core_address_impl_AsRef_str_credentials_Credential_connection_settings_ConnectionSettings]
==== new_core
...
[#_struct_TypeDBDriver_new_core_with_description_address_impl_AsRef_str_credentials_Credential_connection_settings_ConnectionSettings_driver_lang_impl_AsRef_str_]
