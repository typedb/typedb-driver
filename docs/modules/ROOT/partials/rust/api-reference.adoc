...
include::{page-version}@external-typedb-driver::partial$rust/transaction/TransactionOptions.adoc[]

include::{page-version}@external-typedb-driver::partial$rust/transaction/QueryOptions.adoc[]
