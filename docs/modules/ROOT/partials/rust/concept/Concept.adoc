...
Retrieves the vector value of this Concept, if it exists. If this is a vector-valued Attribute Instance, returns the vector value of this instance. If this a vector-valued Value, returns the vector value. Otherwise, returns None.
