...
[source,python]
----
get() -> bool | int | float | Decimal | str | date | Datetime | Duration | Dict[str, Value | None] | List[float]
----
...
[caption=""]
.Returns
`bool | int | float | Decimal | str | date | Datetime | Duration | Dict[str, Value | None] | List[float]`
