...
// tag::methods[]
[#_TypeDB_cluster_driver_addresses_Mapping_str_str_Iterable_str_str_credentials_Credentials_driver_options_DriverOptions]
==== cluster_driver

[source,python]
----
static cluster_driver(addresses: Mapping[str, str] | Iterable[str] | str, credentials: Credentials, driver_options: DriverOptions) -> Driver
----
