...
*Package*: `typedb.api.server.server_replica`
...
a| `role` a| `ReplicaRole \| None` a| Returns whether this is the primary replica of the raft cluster or any of the supporting types.
