...
[#_Driver_primary_replica_server_routing_ServerRouting_None]
==== method ``primary_replica``

[source,python]
----
primary_replica(server_routing: ServerRouting | None = None) -> ServerReplica | None
----
...
[source,python]
----
servers(server_routing: ServerRouting | None = None) -> Set[ServerReplica]
----
