...
==== method <code>fromtimestamp</code>
...
==== method <code>offset_seconds_fromstring</code>
...
==== method <code>utcfromstring</code>
...
==== method <code>utcfromtimestamp</code>
