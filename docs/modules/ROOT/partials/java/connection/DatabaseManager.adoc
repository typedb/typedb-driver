...
[source,java]
----
default void create​(java.lang.String name)
             throws TypeDBDriverException
----

Creates a database with the given name, using default strong consistency. See <<#_create_java_lang_String_com_typedb_driver_api_ConsistencyLevel,``create(String, ConsistencyLevel)``>> for more details and options. 
...
[#_DatabaseManager_create_java_lang_String_ConsistencyLevel]
==== create
