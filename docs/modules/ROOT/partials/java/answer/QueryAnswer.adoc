...
==== method <code>asConceptDocuments</code>
...
==== method <code>asConceptRows</code>
...
==== method <code>isConceptDocuments</code>
...
==== method <code>isConceptRows</code>
