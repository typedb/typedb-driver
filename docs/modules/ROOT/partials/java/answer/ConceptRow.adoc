...
[source,java]
----
java.util.Optional<java.util.stream.Stream<com.typedb.driver.jni.ConjunctionID>> involvedConjunctions()
----
...
[caption=""]
.Returns
`java.util.Optional<java.util.stream.Stream<com.typedb.driver.jni.ConjunctionID>>`
