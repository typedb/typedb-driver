...
[#_static_Driver_TypeDBDriverclusterDriver_const_stdvector_stdstring_addresses_const_Credential_credentials_]
==== clusterDriver

[source,cpp]
----
static Driver TypeDB::Driver::clusterDriver(const std::vector< std::string >& addresses, const Credential& credentials)
----
...
[source,cpp]
----
Driver::clusterDriver(addresses, credentials);
----
