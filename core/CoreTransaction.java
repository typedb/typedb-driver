...
import typedb.client.concept.ConceptManagerImpl;
import typedb.client.logic.LogicManagerImpl;
import typedb.client.query.QueryManagerImpl;
import typedb.client.stream.BidirectionalStream;
import typedb.protocol.TransactionProto.Transaction.Req;
import typedb.protocol.TransactionProto.Transaction.Res;
import typedb.protocol.TransactionProto.Transaction.ResPart;

import java.util.stream.Stream;

import static typedb.client.common.exception.ErrorMessage.Client.TRANSACTION_CLOSED;
import static typedb.client.common.rpc.RequestBuilder.Transaction.commitReq;
import static typedb.client.common.rpc.RequestBuilder.Transaction.openReq;
import static typedb.client.common.rpc.RequestBuilder.Transaction.rollbackReq;
