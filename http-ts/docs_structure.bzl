...
dir_mapping = {
    ...
    "QueryConstraintNot.adoc": "query-structure",
    "QueryConstraintOr.adoc": "query-structure",
    ...
    "QueryConstraintTry.adoc": "query-structure",
    ...
    "QueryVertexNamedRole.adoc": "query-structure",
