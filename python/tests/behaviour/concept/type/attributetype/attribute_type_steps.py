...
def step_impl(context: Context, type_label: str, value_type: ValueType):
    context.tx().getQueryType.put_attribute_type(type_label, value_type).resolve()


@step("attribute({type_label}) get value type: {value_type:ValueType}")
def step_impl(context: Context, type_label: str, value_type: ValueType):
    assert_that(context.tx().getQueryType.get_attribute_type(type_label).resolve().get_value_type(),
                is_(value_type))


@step("attribute({type_label}) get supertype value type: {value_type:ValueType}")
def step_impl(context: Context, type_label: str, value_type: ValueType):
    supertype = context.tx().getQueryType.get_attribute_type(type_label).resolve().get_supertype(context.tx()).resolve().as_attribute_type()
...
def step_impl(context: Context, type_label: str, value_type: ValueType):
    ...
    attribute_type = context.tx().getQueryType.get_attribute_type(type_label).resolve()
...
def step_impl(context: Context, type_label: str, value_type: ValueType, regex: str):
    ...
    attribute_type = context.tx().getQueryType.put_attribute_type(type_label, value_type).resolve()
