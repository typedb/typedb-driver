...
from typedb.native_driver_wrapper import (
    Given as NativeGiven,
    given_variables,
    given_variable_annotations,
...
class _Given(Given, NativeWrapper[NativeGiven]):
    @property
    def _native_object_not_owned_exception(self) -> TypeDBDriverException:
        return TypeDBDriverException(ILLEGAL_STATE)

    def variables(self) -> Iterator["Variable"]:
        native_iter = given_variables(self.native_object)
    ...
    def variable_annotations(self, variable: "Variable") -> Optional["VariableAnnotations"]:
        native_annotations = given_variable_annotations(self.native_object, variable.native_object)
