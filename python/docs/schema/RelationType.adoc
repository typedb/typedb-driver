...
[#_RelationType_get_relates__transaction_TypeDBTransaction__role_label_str_|_None__transitivity_Transitivity]
==== get_relates
...
[#_RelationType_set_relates__transaction_TypeDBTransaction__role_label_str__overridden_label_str_|_None]
==== set_relates
