...
[#_ThingType_get_owns__transaction_TypeDBTransaction__value_type_ValueType_|_None__transitivity_Transitivity__annotations_set_Annotation__|_None]
==== get_owns
...
[#_ThingType_set_owns__transaction_TypeDBTransaction__attribute_type_AttributeType__overridden_type_AttributeType_|_None__annotations_set_Annotation__|_None]
==== set_owns
...
[#_ThingType_set_plays__transaction_TypeDBTransaction__role_type_RoleType__overriden_type_RoleType_|_None]
==== set_plays
