...
async fn test() {
    if !is_cluster() {
        println!("Skipping Cluster tests in a non-clustered environment");
        return;
    }
    ...
    #[cfg(feature = "bazel")]
    let path = "../typedb_behaviour/driver/cluster.feature";

    #[cfg(not(feature = "bazel"))]
    let path = "../../typedb-behaviour/driver/cluster.feature";
