...
REM can't parallelise build for windows:
REM     ERROR: file 'python/python3.dll' is generated by these conflicting actions:
REM     Label: //python:native_driver_python314, //python:native_driver_python311
