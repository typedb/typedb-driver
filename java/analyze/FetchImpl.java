...
public class FetchImpl extends NativeObject<com.typedb.driver.jni.Fetch> implements Fetch {
    public FetchImpl(com.typedb.driver.jni.Fetch fetch) {
        super(fetch);
    }
    ...
    public FetchImpl asListGetElement() {
        return new FetchImpl(com.typedb.driver.jni.typedb_driver.fetch_list_element(nativeObject));
    }
    ...
    public FetchImpl asObjectGetField(String field) {
        return new FetchImpl(com.typedb.driver.jni.typedb_driver.fetch_object_get_field(nativeObject, field));
    }
}
