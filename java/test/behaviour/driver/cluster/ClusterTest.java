...
package com.typedb.driver.test.behaviour.driver.cluster;
...
@CucumberOptions(
        ...
        features = "external/typedb_behaviour/driver/cluster.feature",
        tags = "not @ignore and not @ignore-typedb-driver and not @ignore-typedb-driver-java"
)
public class ClusterTest extends BehaviourTest {
    // ATTENTION:
