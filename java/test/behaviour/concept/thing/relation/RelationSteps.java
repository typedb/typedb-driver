...
package com.vaticle.typedb.driver.test.behaviour.concept.thing.relation;
...
public class RelationSteps {
    ...
    public void relation_type_create_new_instance(String var, String typeLabel) {
        put(var, tx().concepts().getRelationType(typeLabel).resolve().create(tx()).resolve());
    }
    ...
    public void relation_type_create_new_instance_throws_exception(String typeLabel) {
        assertThrows(() -> tx().concepts().getRelationType(typeLabel).resolve().create(tx()).resolve());
    }
    ...
    public void relation_type_create_new_instance_with_key(String var, String type, String keyType, int keyValue) {
        Attribute key = tx().concepts().getAttributeType(keyType).resolve().put(tx(), keyValue).resolve();
        Relation relation = tx().concepts().getRelationType(type).resolve().create(tx()).resolve();
    ...
    public void relation_type_get_instance_with_key(String var1, String type, String keyType, long keyValue) {
        put(var1, tx().concepts().getAttributeType(keyType).resolve().get(tx(), keyValue).resolve().getOwners(tx()).filter(owner -> owner.getType().getLabel().equals(Label.of(type))).findFirst().orElse(null));
    }
    ...
    public void relation_type_get_instances_contain(String typeLabel, String var) {
        assertTrue(tx().concepts().getRelationType(typeLabel).resolve().getInstances(tx()).anyMatch(i -> i.equals(get(var))));
    }
    ...
    public void relation_type_get_instances_do_not_contain(String typeLabel, String var) {
        assertTrue(tx().concepts().getRelationType(typeLabel).resolve().getInstances(tx()).noneMatch(i -> i.equals(get(var))));
    }

    @Then("relation\\( ?{type_label} ?) get instances is empty")
    public void relation_type_get_instances_is_empty(String typeLabel) {
        assertEquals(0, tx().concepts().getRelationType(typeLabel).resolve().getInstances(tx()).count());
    }
    ...
    public void relation_add_player_for_role(String var1, String roleTypeLabel, String var2) {
        get(var1).asRelation().addPlayer(tx(), get(var1).asRelation().getType().getRelates(tx(), roleTypeLabel).resolve(), get(var2)).resolve();
    }
    ...
    public void relation_add_player_for_role_throws_exception(String var1, String roleTypeLabel, String var2) {
        assertThrows(() -> get(var1).asRelation().addPlayer(tx(), get(var1).asRelation().getType().getRelates(tx(), roleTypeLabel).resolve(), get(var2)).resolve());
    }
    ...
    public void relation_remove_player_for_role(String var1, String roleTypeLabel, String var2) {
        get(var1).asRelation().removePlayer(tx(), get(var1).asRelation().getType().getRelates(tx(), roleTypeLabel).resolve(), get(var2)).resolve();
    }
    ...
    public void relation_get_players_contain(String var, Map<String, String> players) {
        ...
        players.forEach((rt, var2) -> assertTrue(relation.getPlayers(tx()).get(relation.getType().getRelates(tx(), rt).resolve()).contains(get(var2.substring(1)))));
    }
    ...
    public void relation_get_players_do_not_contain(String var, Map<String, String> players) {
        ...
        players.forEach((rt, var2) -> {
            ...
            if ((p = relation.getPlayers(tx()).get(relation.getType().getRelates(tx(), rt).resolve())) != null) {
    ...
    public void relation_get_players_for_role_contain(String var1, String roleTypeLabel, String var2) {
        assertTrue(get(var1).asRelation().getPlayersByRoleType(tx(), get(var1).asRelation().getType().getRelates(tx(), roleTypeLabel).resolve()).anyMatch(p -> p.equals(get(var2))));
    }
    ...
    public void relation_get_players_for_role_do_not_contain(String var1, String roleTypeLabel, String var2) {
        assertTrue(get(var1).asRelation().getPlayersByRoleType(tx(), get(var1).asRelation().getType().getRelates(tx(), roleTypeLabel).resolve()).noneMatch(p -> p.equals(get(var2))));
    }
}
