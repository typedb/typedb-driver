...
import CLUSTER_TOKEN_CREDENTIAL_INVALID = ErrorMessage.Driver.CLUSTER_TOKEN_CREDENTIAL_INVALID;
...
export class TypeDBStubImpl extends TypeDBStub {
    ...
    async mayRenewToken<RES>(fn: () => Promise<RES>): Promise<RES> {
        try {
            ...
            if (e instanceof TypeDBDriverError && CLUSTER_TOKEN_CREDENTIAL_INVALID === e.messageTemplate) {
