...
export namespace ErrorMessage {
    ...
    export namespace Driver {
        ...
        export const CLOUD_UNABLE_TO_CONNECT = new Driver(15, (args: Stringable[]) => `Unable to connect to TypeDB Cluster. Attempted connecting to the cluster nodes, but none are available: '${args[1]}'.`);
        export const CLOUD_REPLICA_NOT_PRIMARY = new Driver(16, () => `The replica is not the primary replica.`);
        export const CLOUD_ALL_NODES_FAILED = new Driver(17, (args: Stringable[]) => `Attempted connecting to all cluster nodes, but the following errors occurred: \n'${args[0]}'`);
