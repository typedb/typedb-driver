...
[#_ConceptManager_getAttributeType]
==== getAttributeType
...
[#_ConceptManager_getRelationType]
==== getRelationType
...
[#_ConceptManager_putAttributeType]
==== putAttributeType
...
[#_ConceptManager_putRelationType]
==== putRelationType
