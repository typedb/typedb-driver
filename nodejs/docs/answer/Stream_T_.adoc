...
[#_Stream_T_every__callbackFn___value__=__unknown_]
==== every
...
[#_Stream_T_filter__filter___value__=__boolean_]
==== filter
...
[#_Stream_T_flatMap__mapper___value__=__Stream_U__]
==== flatMap
...
[#_Stream_T_forEach__fn___value__=__void_]
==== forEach
...
[#_Stream_T_map__mapper___value__=__U_]
==== map
...
[#_Stream_T_some__callbackFn___value__=__unknown_]
==== some
