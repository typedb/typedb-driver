 ...
 */
class RemoteEntityTypeImpl extends RemoteTypeImpl<RemoteEntityType, RemoteEntity, EntityType, Entity> implements RemoteEntityType {
    ...
    @Override
    protected final RemoteEntity asInstance(RemoteConcept<RemoteEntity, Entity> concept) {
