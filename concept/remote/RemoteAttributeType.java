...
public interface RemoteAttributeType<D> extends AttributeType<D, RemoteAttributeType<D>, RemoteAttribute<D>>,
     ...
     */
    RemoteAttributeType<D> label(Label label);
     ...
     */
    @Override
    RemoteAttributeType<D> isAbstract(Boolean isAbstract);
     ...
     * @return The AttributeType itself.
     */
    RemoteAttributeType<D> regex(String regex);
     ...
     */
    RemoteAttribute<D> create(D value);
    ...
    @CheckReturnValue
    @Nullable
    RemoteAttribute<D> attribute(D value);
     ...
     */
    @Override
    Stream<RemoteAttributeType<D>> sups();
     ...
     */
    @Override
    Stream<RemoteAttributeType<D>> subs();
     ...
     */
    @Override
    Stream<RemoteAttribute<D>> instances();
    ...
    @CheckReturnValue
    @Override
    default RemoteAttributeType<D> asAttributeType() {
        return this;
    }
