...
public class SessionSteps {
    ...
    public void connection_open_sessions_in_parallel_for_keyspaces(List<String> names) {
        ...
        for (String name : names) {
            ConnectionSteps.sessionsInParallel.add(CompletableFuture.supplyAsync(
    ...
    public void sessions_in_parallel_are_null(Boolean isNull) {
        Stream<CompletableFuture<Void>> assertions = ConnectionSteps.sessionsInParallel
    ...
    public void sessions_in_parallel_have_keyspaces(List<String> names) {
        assertEquals(names.size(), ConnectionSteps.sessionsInParallel.size());
        Iterator<CompletableFuture<GraknClient.Session>> futureSessionIter = ConnectionSteps.sessionsInParallel.iterator();
