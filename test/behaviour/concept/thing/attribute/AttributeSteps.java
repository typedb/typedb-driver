...
public class AttributeSteps {
    ...
    public void attribute_has_value_type(String var, ValueTypeOld valueType) {
    ...
    public void attribute_type_as_boolean_put(String var, String typeLabel, boolean value) {
        put(var, tx().getAttributeType(typeLabel).asAttributeType(ValueTypeOld.BOOLEAN).put(value));
    }
    ...
    public void attribute_type_as_boolean_put_throws_exception(String typeLabel, boolean value) {
        assertThrows(() -> tx().getAttributeType(typeLabel).asAttributeType(ValueTypeOld.BOOLEAN).put(value));
    }
    ...
    public void attribute_type_as_long_put(String var, String typeLabel, long value) {
        put(var, tx().getAttributeType(typeLabel).asAttributeType(ValueTypeOld.LONG).put(value));
    }
    ...
    public void attribute_type_as_long_put_throws_exception(String typeLabel, long value) {
        assertThrows(() -> tx().getAttributeType(typeLabel).asAttributeType(ValueTypeOld.LONG).put(value));
    }
    ...
    public void attribute_type_as_double_put(String var, String typeLabel, double value) {
        put(var, tx().getAttributeType(typeLabel).asAttributeType(ValueTypeOld.DOUBLE).put(value));
    }
    ...
    public void attribute_type_as_double_put_throws_exception(String typeLabel, double value) {
        assertThrows(() -> tx().getAttributeType(typeLabel).asAttributeType(ValueTypeOld.DOUBLE).put(value));
    }
    ...
    public void attribute_type_as_string_put(String var, String typeLabel, String value) {
        put(var, tx().getAttributeType(typeLabel).asAttributeType(ValueTypeOld.STRING).put(value));
    }
    ...
    public void attribute_type_as_string_put_throws_exception(String typeLabel, String value) {
        assertThrows(() -> tx().getAttributeType(typeLabel).asAttributeType(ValueTypeOld.STRING).put(value));
    }
    ...
    public void attribute_type_as_datetime_put(String var, String typeLabel, LocalDateTime value) {
        put(var, tx().getAttributeType(typeLabel).asAttributeType(ValueTypeOld.DATETIME).put(value));
    }
    ...
    public void attribute_type_as_datetime_put_throws_exception(String typeLabel, LocalDateTime value) {
        assertThrows(() -> tx().getAttributeType(typeLabel).asAttributeType(ValueTypeOld.DATETIME).put(value));
    }
    ...
    public void attribute_type_as_boolean_get(String var, String typeLabel, boolean value) {
        put(var, tx().getAttributeType(typeLabel).asAttributeType(ValueTypeOld.BOOLEAN).get(value));
    }
    ...
    public void attribute_type_as_long_get(String var, String typeLabel, long value) {
        put(var, tx().getAttributeType(typeLabel).asAttributeType(ValueTypeOld.LONG).get(value));
    }
    ...
    public void attribute_type_as_double_get(String var, String typeLabel, double value) {
        put(var, tx().getAttributeType(typeLabel).asAttributeType(ValueTypeOld.DOUBLE).get(value));
    }
    ...
    public void attribute_type_as_string_get(String var, String typeLabel, String value) {
        put(var, tx().getAttributeType(typeLabel).asAttributeType(ValueTypeOld.STRING).get(value));
    }
