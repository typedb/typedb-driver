...
// tag::methods[]
[#_const_JSONArray_TypeDBJSONasArray_____const]
==== asArray
...
[#_const_JSONBoolean_TypeDBJSONasBoolean_____const]
==== asBoolean
...
[#_const_JSONDouble_TypeDBJSONasDouble_____const]
==== asDouble
...
[#_const_JSONLong_TypeDBJSONasLong_____const]
==== asLong
...
[#_const_JSONMap_TypeDBJSONasMap_____const]
==== asMap
...
[#_const_JSONString_TypeDBJSONasString_____const]
==== asString
