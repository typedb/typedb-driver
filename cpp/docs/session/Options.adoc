...
[#_stdoptional_bool__TypeDBOptionsexplain___]
==== explain
...
[#_Options_TypeDBOptionsexplain___bool_explain_]
==== explain
...
[#_stdoptional_bool__TypeDBOptionsinfer___]
==== infer
...
[#_Options_TypeDBOptionsinfer___bool_infer_]
==== infer
...
[#_stdoptional_bool__TypeDBOptionsparallel___]
==== parallel
...
[#_Options_TypeDBOptionsparallel___bool_parallel_]
==== parallel
...
[#_stdoptional_bool__TypeDBOptionsprefetch___]
==== prefetch
...
[#_Options_TypeDBOptionsprefetch___bool_prefetch_]
==== prefetch
...
[#_stdoptional_int32_t__TypeDBOptionsprefetchSize___]
==== prefetchSize
...
[#_Options_TypeDBOptionsprefetchSize___int32_t_prefetchSize_]
==== prefetchSize
...
[#_stdoptional_bool__TypeDBOptionsreadAnyReplica___]
==== readAnyReplica
...
[#_Options_TypeDBOptionsreadAnyReplica___bool_readAnyReplica_]
==== readAnyReplica
...
[#_stdoptional_int64_t__TypeDBOptionsschemaLockAcquireTimeoutMillis___]
...
[#_Options_TypeDBOptionsschemaLockAcquireTimeoutMillis___int64_t_timeoutMillis_]
==== schemaLockAcquireTimeoutMillis
...
[#_stdoptional_int64_t__TypeDBOptionssessionIdleTimeoutMillis___]
...
[#_Options_TypeDBOptionssessionIdleTimeoutMillis___int64_t_timeoutMillis_]
==== sessionIdleTimeoutMillis
...
[#_stdoptional_bool__TypeDBOptionstraceInference___]
==== traceInference
...
[#_Options_TypeDBOptionstraceInference___bool_traceInference_]
==== traceInference
...
[#_stdoptional_int64_t__TypeDBOptionstransactionTimeoutMillis___]
...
[#_Options_TypeDBOptionstransactionTimeoutMillis___int64_t_timeoutMillis_]
==== transactionTimeoutMillis
