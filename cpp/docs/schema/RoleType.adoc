...
[#_ConceptIterable_Thing__TypeDBRoleTypegetPlayerInstances___Transaction__transaction__Transitivity_transitivity__TransitivityTRANSITIVE_]
==== getPlayerInstances
...
[#_ConceptIterable_ThingType__TypeDBRoleTypegetPlayerTypes___Transaction__transaction__Transitivity_transitivity__TransitivityTRANSITIVE_]
==== getPlayerTypes
...
[#_ConceptIterable_Relation__TypeDBRoleTypegetRelationInstances___Transaction__transaction__Transitivity_transitivity__TransitivityTRANSITIVE_]
...
[#_ConceptPtrFuture_RelationType__TypeDBRoleTypegetRelationType___Transaction__transaction_]
==== getRelationType
...
[#_ConceptIterable_RelationType__TypeDBRoleTypegetRelationTypes___Transaction__transaction_]
==== getRelationTypes
...
[#_ConceptIterable_RoleType__TypeDBRoleTypegetSubtypes___Transaction__transaction__Transitivity_transitivity__TransitivityTRANSITIVE_]
==== getSubtypes
...
[#_ConceptPtrFuture_RoleType__TypeDBRoleTypegetSupertype___Transaction__transaction_]
==== getSupertype
...
[#_ConceptIterable_RoleType__TypeDBRoleTypegetSupertypes___Transaction__transaction_]
==== getSupertypes
