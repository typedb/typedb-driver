...
// tag::methods[]
[#_ConceptPtrFuture_Entity__TypeDBEntityTypecreate___Transaction__transaction_]
==== create
...
[#_ConceptIterable_Entity__TypeDBEntityTypegetInstances___Transaction__transaction__Transitivity_transitivity__TransitivityTRANSITIVE_]
==== getInstances
...
[#_ConceptIterable_EntityType__TypeDBEntityTypegetSubtypes___Transaction__transaction__Transitivity_transitivity__TransitivityTRANSITIVE_]
==== getSubtypes
