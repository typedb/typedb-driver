...
[source,cpp]
----
virtual VoidFuture TypeDB::ThingType::deleteType(Transaction& transaction) overridevirtual
----
...
[source,cpp]
----
virtual std::string TypeDB::ThingType::getLabel() overridevirtual
----
...
[source,cpp]
----
virtual bool TypeDB::ThingType::isAbstract() overridevirtual
----
...
[source,cpp]
----
virtual BoolFuture TypeDB::ThingType::isDeleted(Transaction& transaction) overridevirtual
----
...
[source,cpp]
----
virtual VoidFuture TypeDB::ThingType::setLabel(Transaction& transaction, const std::string& newLabel) overridevirtual
----
