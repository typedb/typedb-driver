...
// tag::methods[]
[#_ConceptIterable_Thing__TypeDBAttributegetOwners___Transaction__transaction_]
==== getOwners
...
[#_ConceptIterable_Thing__TypeDBAttributegetOwners___Transaction__transaction__const_ThingType__ptr__ownerType_]
==== getOwners
...
[#_stdunique_ptr_AttributeType__TypeDBAttributegetType___]
==== getType
...
[#_stdunique_ptr_Value__TypeDBAttributegetValue___]
==== getValue
