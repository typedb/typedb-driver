...
[#_stdmap_stdunique_ptr_RoleType___stdunique_ptr_Thing____TypeDBRelationgetPlayers___Transaction__transaction_]
==== getPlayers
...
[#_ConceptIterable_Thing__TypeDBRelationgetPlayersByRoleType___Transaction__transaction__const_stdvector__stdunique_ptr__RoleType_____roleTypes_]
...
[#_ConceptIterable_Thing__TypeDBRelationgetPlayersByRoleType___Transaction__transaction__const_stdvector__RoleType__ptr_____roleTypes_]
==== getPlayersByRoleType
...
See <<#_ConceptIterable_Thing__TypeDBRelationgetPlayersByRoleType___Transaction__transaction__const_stdvector__stdunique_ptr__RoleType_____roleTypes_,getPlayersByRoleType>>

[caption=""]
.Returns
`ConceptIterable< Thing >`

[#_ConceptIterable_RoleType__TypeDBRelationgetRelating___Transaction__transaction_]
==== getRelating
...
[#_stdunique_ptr_RelationType__TypeDBRelationgetType___]
==== getType
