    ...
    cucumber_bdd::TestRunner<TypeDB::BDD::Context> driver(
        {
            ...
            TypeDB::BDD::userSteps,
            TypeDB::BDD::databaseSteps,
            TypeDB::BDD::sessionSteps,
            TypeDB::BDD::transactionSteps,
            TypeDB::BDD::querySteps,

            TypeDB::BDD::thingTypeSteps,
            TypeDB::BDD::attributeTypeSteps,
            TypeDB::BDD::entityTypeSteps,
            TypeDB::BDD::relationTypeSteps,

            TypeDB::BDD::thingAPISteps,
            TypeDB::BDD::attributeSteps,
            TypeDB::BDD::entitySteps,
            TypeDB::BDD::relationSteps,
        },
