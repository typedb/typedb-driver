...
load("@rules_rust//rust:repositories.bzl", "rules_rust_dependencies", "rust_analyzer_toolchain_tools_repository", "rust_register_toolchains")
...
# Load repositories
load("//dependencies/vaticle:repositories.bzl", "vaticle_typedb_behaviour", "vaticle_typedb_protocol", "vaticle_typeql")
